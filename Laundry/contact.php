				...
				<div class="tt-col-right tt-col-objects">
					<div class="tt-col__item d-block d-lg-none">
						<div class="h-info02">
							<div class="tt-item">
								<address>
									<a href="tel:061-4571501"><span class="icons-483947"></span> 061-457-1501</a>
								</address>
							</div>
						</div>
					</div>
...
<main id="tt-pageContent">
			...
			<div class="row info03__wrapper">
				<div class="col-custom-450 col-6 col-md-3">
					<div class="info03">
						...
						<h6 class="info03__title">ที่อยู่</h6>
						<address>
							778/8 Sriracha,<br>VA, 10280
						</address>
					</div>
				</div>
				<div class="col-custom-450 col-6 col-md-3">
					<div class="info03">
						...
						<h6 class="info03__title">เบอร์ติดต่อ</h6>
						<address>
							<a href="tel:061-457-1501">061-457-1501</a>
						</address>
					</div>
				</div>
				<div class="col-custom-450 col-6 col-md-3">
					<div class="info03">
						...
						<h6 class="info03__title">อีเมล</h6>
						<address>
							<a href="mailto:info@yourlaundrysite.com">taeoven@gmail.com</a>
						</address>
					</div>
				</div>
				<div class="col-custom-450 col-6 col-md-3">
					<div class="info03">
						...
						<h6 class="info03__title">เวลาเปิดทำการ</h6>
						<address>
							Mon-Fri 08:00 AM - 05:00 PM
						</address>
						<address>
	...
	<div class="tt-posirion-relative">
				...
				<div class="col-lg-6">
					<div class="map-layout">
						<div class="title-block">
							<h4 class="title-block__title">
								ติดต่อเรา  <br>พวกเราพร้อมให้ความช่วยเหลือ
							</h4>
						</div>
						<p>
							ขอบคุณที่มาใช้บริการกับเรา หวังว่าคุณจะได้รับความพึ่งพอใจในการใช้บริการ
						</p>
		...
		<div id="map" class="map-layout-wrapper lazyload" data-bg="images/map-contact.jpg">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3876.0087268178435!2d100.92608921526573!3d13.167715115478584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3102b39051ae5b91%3A0x7fbb473d9e63be5c!2sKasetsart%20University%20Sriracha%20Campus!5e0!3m2!1sth!2sth!4v1696254524826!5m2!1sth!2sth" allowfullscreen="" aria-hidden="false"></iframe>
		</div>		
	</div>
	</main>
<footer id="tt-footer">
